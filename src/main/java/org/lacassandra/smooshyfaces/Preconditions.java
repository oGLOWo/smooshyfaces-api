/*
 * Copyright (C) 2013 Adrian Rodriguez - oGLOWo
 *
...
/**
 * This class is a clone of Guava's Preconditions with methods that can
 * throw custom exceptions instead of the NullPointerException, IllegalArgumentException,
...
public final class Preconditions {
     ...
     *
     * @param expression a boolean expression
     * @param throwableClass the type of exception to throw if the expression is not true
     * @throws IllegalArgumentException if {@code expression} is false and throwableClass is null,
     * otherwise an instance of throwableClass
     */
    public static void checkArgument(boolean expression, Class<? extends RuntimeException> throwableClass) {
        if (!expression) {
            if (throwableClass != null) {
                RuntimeException t = null;
                try {
                    t = throwableClass.newInstance();
                }
     ...
     * @param throwableClass the type of exception to throw if the expression is not true
     * @throws IllegalArgumentException if {@code expression} is false and throwableClass is null,
     * otherwise an instance of throwableClass whose constructor takes errorMessage as an
     * argument
     */
    public static void checkArgument(
            boolean expression, @Nullable Object errorMessage, Class<? extends RuntimeException> throwableClass) {
        if (!expression) {
            if (throwableClass != null) {
                RuntimeException t = null;
                try {
                    t = throwableClass.getConstructor(String.class).newInstance(errorMessage);
                }
