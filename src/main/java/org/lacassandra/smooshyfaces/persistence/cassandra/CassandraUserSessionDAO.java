...
public class CassandraUserSessionDAO extends BaseCassandraDAO<UserSession, Long> implements UserSessionDAO {
    ...
    protected final static ColumnFamily<UUID, String> COLUMN_FAMILY_USER_SESSIONS = new ColumnFamily<>("user_sessions",
            TimeUUIDSerializer.get(),
            StringSerializer.get(),
            ByteBufferSerializer.get());

    protected final static ColumnFamily<String, String> COLUMN_FAMILY_USER_SESSIONS_INVERTED = new ColumnFamily<>("user_sessions_inverted",
            StringSerializer.get(),
            StringSerializer.get(),
            ByteBufferSerializer.get());
