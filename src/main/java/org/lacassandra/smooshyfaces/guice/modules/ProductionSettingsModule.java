...
public class ProductionSettingsModule extends AbstractModule {
    @Override
    protected void configure() {
        // Astyanax/Cassandra Settings
        bind(String.class).annotatedWith(Names.named("SEED_HOSTS")).toInstance("your-production-server-1.com:9160,your-production-server-2.com:9160");
        bind(String.class).annotatedWith(Names.named("CASSANDRA_CLUSTER_NAME")).toInstance("SmooshyFacesIncCluster");
        ...
        bind(String.class).annotatedWith(Names.named("API_SERVERS")).toInstance("api-1.yourdomain.com,api-2.yourdomain.com,api-3.yourdomain.com,api-4.yourdomain.com");
